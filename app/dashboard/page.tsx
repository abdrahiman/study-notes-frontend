...
const Dashboard = () => {
  ...
  const [lessons] = useState([
    { id: 1, title: 'Biology 101', subject: 'Biology', teacher: 'Jane Smith', status: 'active', students: 25 },
    { id: 2, title: 'Chemistry Basics', subject: 'Chemistry', teacher: 'Mike Johnson', status: 'active', students: 30 }
  ]);

  const [submissions] = useState([
    { id: 1, title: 'Biology Notes Ch.1', student: 'John Doe', lesson: 'Biology 101', status: 'accepted' },
    { id: 2, title: 'Chemistry Equations', student: 'Sarah Chen', lesson: 'Chemistry Basics', status: 'pending' }
  ]);
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className={`flex items-center p-4 ${isSidebarCollapsed ? 'justify-center' : 'justify-between'}`}>
          {!isSidebarCollapsed && <h1 className="text-xl font-bold text-gray-800">خلاصة</h1>}
          <button
        ...
        <div className="p-3 border-t">
          <button className={`w-full flex items-center gap-2 space-x-3 px-3 py-3 text-gray-600 hover:bg-gray-50 rounded-lg
            ${isSidebarCollapsed ? 'justify-center' : ''}`}
          >
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">البريد الاكتبروني</label>
            <input
              type="email"
              className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Sidebar />
      <main className={`transition-all duration-300 ease-in-out ${isSidebarCollapsed ? 'mr-16' : 'mr-64'} p-6`}>
